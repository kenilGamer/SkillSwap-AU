...
const FormLabel = React.forwardRef((_a, ref) => {
    ...
    return (<label_1.Label ref={ref} className={(0, utils_1.cn)(error && "text-red-500 dark:text-red-900", className)} htmlFor={formItemId} {...props}/>);
});
...
const FormDescription = React.forwardRef((_a, ref) => {
    ...
    return (<p ref={ref} id={formDescriptionId} className={(0, utils_1.cn)("text-[0.8rem] text-slate-500 dark:text-slate-400", className)} {...props}/>);
});
...
const FormMessage = React.forwardRef((_a, ref) => {
    ...
    return (<p ref={ref} id={formMessageId} className={(0, utils_1.cn)("text-[0.8rem] font-medium text-red-500 dark:text-red-900", className)} {...props}>
      {body}
    </p>);
});
