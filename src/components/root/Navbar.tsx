            ...
            <nav aria-label="Main navigation" className="relative flex h-screen w-16 flex-shrink-0 flex-col items-center justify-between bg-gradient-to-b from-indigo-50 to-indigo-100 p-3 shadow-lg">
                        ...
                        <TooltipTrigger asChild>
                            <motion.div whileHover={{ scale: 1.08 }}>
                                <button
                                    ...
                                    className="relative flex aspect-square w-10 items-center justify-center rounded-lg text-2xl text-indigo-600 hover:bg-indigo-200 hover:text-indigo-900 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2"
                                >
                ...
                {showSearch && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, x: -20 }}
                        className="absolute left-16 top-4 w-64"
                    >
                        <div className="relative">
                            <Input
                                type="search"
                                placeholder="Search..."
                                className="w-full rounded-lg bg-white pl-8 shadow-lg"
                            />
