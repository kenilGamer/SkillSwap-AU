...
function Profile({ user }) {
    var _a, _b, _c;
    return (<div className="flex w-full flex-col gap-5 overflow-hidden bg-accent p-5">
            <div className="flex flex-col gap-5 rounded-xl border bg-white p-5 shadow-sm">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {!((_b = user.skills) === null || _b === void 0 ? void 0 : _b.length) && <span className="text-sm text-black/70">{user.name} has no skills</span>}
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-sm text-black/70">{user.bio || <span className="text-sm text-black/70">{"He haven't added any bio"}</span>}</p>
                </div>
            </div>
        </div>);
}
